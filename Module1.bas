...
Public Function ImprimeSegundaViadoRequerimento(NumerodoNIT As String, ImpressãoAutomática As Boolean) As Requerimento
        ...
        Wend '
        SetForegroundWindow (GlobalIDControleOperacional)
        'SetForegroundWindow (IDFormulárioSegundaViaMarcaçãodeExame)
        ...
        Wend
        'botões habilitados
        'verifica se a impressão é automatica ou acionada pelo usuário
        'If ImpressãoAutomática = True Then
        'Espera 200
...
'espera tela Imprimindo... abrir
        ...
        'PostMessage IDTelaImprimindo, WM_CLOSE, 0, 0
 ...
 'espera tela Imprimindo... fechar
        ...
        'hThunderRT6CommandButtonImprimir = 0
        'While hThunderRT6CommandButtonImprimir = 0
            'hThunderRT6CommandButtonImprimir = FindWindowEx(IDCriticadoSABIsobreSegundaVia, 0, "Button", "&Sim")
            'contador = contador + 1
            'If contador > 5000 Then
                'Exit Function
            'End If
        'Wend
        'PostMessage IDCriticadoSABIsobreSegundaVia, BM_CLICK, 0, 0
        'espera tela ser fechada
